...
impl Aes {
    ...
    pub(crate) fn new_gcm(aes: AesReg, aes_clp: AesClpReg) -> Self {
        Self { aes, aes_clp }
    }
    ...
    /// Internal implementation of AES-256-GCM encrypt (called by KAT and AesGcm wrapper)
    #[cfg_attr(not(feature = "no-cfi"), cfi_impl_fn)]
    #[inline(always)]
    ...
    /// Internal implementation of AES-256-GCM decrypt (called by KAT and AesGcm wrapper)
    #[cfg_attr(not(feature = "no-cfi"), cfi_impl_fn)]
    #[inline(always)]
...
impl AesGcm {
    ...
    pub fn encrypt(
        ...
        self.aes
            .aes_256_gcm_encrypt_impl(trng, iv, key, aad, plaintext, ciphertext, tag_size)
    }
    ...
    pub fn decrypt(
        ...
        self.aes
            .aes_256_gcm_decrypt_impl(trng, iv, key, aad, ciphertext, plaintext, tag)
    }
